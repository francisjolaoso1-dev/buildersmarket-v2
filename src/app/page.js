          ...
          <div style={{ backgroundColor: '#ffffff', padding: '25px', borderRadius: '12px', maxWidth: '460px', width: '100%', margin: '20px', position: 'relative', maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            {!invoiceConfirmed ? (
              ...
              <>
                ...
                <p style={{ color: '#6b7280', fontSize: '13px', marginBottom: '20px' }}>Account Assignment: <strong style={{ color: '#111827' }}>{procurementMode === 'corporate' ? corpDetails.companyName || 'Corporate Account' : (currentUser ? currentUser.name : 'Individual Builder')}</strong></p>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  <button onClick={() => setTrackingStep(prev => Math.min(prev + 1, 4))} disabled={trackingStep === 4} style={{ flex: 1, backgroundColor: '#111827', color: '#fff', border: 'none', padding: '10px', borderRadius: '6px', cursor: 'pointer' }}>{trackingStep === 4 ? 'Order Complete' : 'Advance Stage'}</button>
